...
namespace TimeManagementSystem
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private async Task ConfigSendGridAsync(IdentityMessage message)
        {
            ...
            myMessage.SetFrom(new EmailAddress(ConfigurationManager.AppSettings["SendGridEmail"], AppAttributes.Name));
            ...
            {
                Trace.TraceError("Failed to send e-mail: ." + err.Message);
